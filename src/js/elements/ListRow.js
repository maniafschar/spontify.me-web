...
<imagelist>
	<img ${(this.getAttribute('image').indexOf('images/') == 0 ? 'source="' : 'src="' + global.serverImg) + this.getAttribute('image')}" class="${(!this.getAttribute('image') || this.getAttribute('image').indexOf('/') < 0) && this.getAttribute('image') != 'admin' ? 'mainBG default' : ''}" />
