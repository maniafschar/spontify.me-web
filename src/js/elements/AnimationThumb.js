marketing.data={clientMarketingResult:{}};marketing.data.storage={ prolog: 'Lieber Sky Kunde,<br/><br/>unsere Community ist auf der suche nach den besten Live-Locations in ihrer Umgebung. Unsere App listet auch Deine Location.<br/><br/>Möchtest Du noch mehr Gäste?', epilog:'Lieben Dank für Deine Teilnahme, wir melden uns gegenbenenfalls bei Dir.',questions:[{question: 'Stimmen Name und Adresse Deiner Location?',textField:true},{question:'Möchtest Du Marketing-Aufkleber als Aushang für Gäste und/oder zum platzieren an prominanter Stelle, z.B. Sanitäranlagen, Eingang, etc.?', answers:['20', '50']},{question:'Möchtest Du jetzt einen Zugang anlegen?',answers:['Ja','Nein']},{question:'Bist Du an einer engeren Zusammenarbeit interessiert, um z.B. um Events in Deiner Location zu promoten?',answers:['Ja','Nein']},{question:'Hast Du weitere Anmerkungen/Anregungen für uns?',textField:true}] };marketing.open()
