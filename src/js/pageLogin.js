...
<form>
	...
	<dialogButtons>
		...
		<br />
		<br />
		<button-text onclick="pageLogin.openApple()" class="loginExternal"
				...
				if (page1 || page2) {
					...
					setTimeout(function () {
						if (ui.navigation.getActiveID() == 'home') {
							intro.openHint({ desc: '<div style="margin-bottom:0.5em;">' + ui.l('settings.completeProfile') + '</div>' + page1 + page2 + '<button-text style="margin-top:0.5em;" onclick="pageLogin.saveProfile()">' + ui.l('save') + '</button-text>', pos: '5%,20vh', size: '90%,auto', hinky: 'left:50%;', hinkyClass: 'top', onclick: 'return' });
