...
<div>${v.skills}${v.news}</div>
	...
	static closeNews() {
		...
		if (user.contact)
			...
			ui.navigation.openHint({ desc: '<div style="width:100%;max-height:80vh;overflow-y:auto;"><img src="images/celebrate.svg" style="max-width:70%;"/><br/>' + ui.l('marketing.engageToRegister') + '</div>', pos: '5%,2em', size: '90%,auto', onclick: 'return false;' });
	}
	static filterClose() {
