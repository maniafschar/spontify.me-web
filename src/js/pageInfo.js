...
<infoblock id="info2" style="display:none;">
	...
	static templateCopyright = v =>
		global.template`<div style="text-align:center;padding:2em 1em;clear:both;">${ui.l('info.infoOther')}<br/>© ${new Date().getFullYear()} ${ui.l('info.copyright')}<localisation onclick="pageInfo.openMap()" style="display:block;margin-top:2em;cursor:pointer;"></localisation></div>`;
